        ...
        <form onSubmit={handleLogin} className="space-y-8">
          ...
          {error && (
            <div
              ...
              className="bg-red-500/10 border border-red-500/20 text-red-400 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest text-center animate-shake"
            >
              {error}
            </div>
          )}
